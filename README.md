...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-lgkwq-g.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-lgkwq-g.containers.anotherwebservice.com/
...
```
git clone git@github.com:t924417424/container-lgkwq-g.git
```
...
```
docker attach container-lgkwq-g
```
